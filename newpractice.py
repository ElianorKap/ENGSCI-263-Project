...
def plot_kettle_model():
    ...
    def Tmodel(t, *pars):
        tm, Tm = solve_ode_kettle(ode_model, 2009, 2019, 0.25, 25.16, [10.87, a, b])
        return Tm

    # p0 = [5.2e-4,0.7e-3]
    # our guess
    p0 = [5.1e-4, 0.65e-3]
    constants = curve_fit(Tmodel, time, pressure)
    ...
    x0 = 22
    tmi, Tmi = solve_kettle_ode(ode_model, to, x0, pars)
    ...
    constants=curve_fit(Tmodel, tb, pb)
...
# our guess
p0 = [5.1e-4, 0.65e-3]
constants = curve_fit(Tmodel, to, To, p0)
a_const = constants[0][0]
b_const = constants[0][1]
print(a_const)
print(b_const)
